...
NEXT: Wave 0 T4 — docs materialization (docs/design-packs/registry.md, design-pack-contract.md, conversion-contract.md, failure-register.md at repo root docs/; docs/aether/manifest.md) — NOT authorized yet. Then T5 AETHER chrome. Waves 1-3 (AETHER commerce core) after Wave 0.
