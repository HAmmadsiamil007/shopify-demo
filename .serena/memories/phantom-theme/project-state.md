...
NEXT: Wave 0 T3 — template archives (product.aether.json / collection.aether.json / index.aether.json + promotion/rollback contract) — NOT authorized yet. Then T4 docs materialization, T5 AETHER chrome. Waves 1-3 (AETHER commerce core) after Wave 0.
